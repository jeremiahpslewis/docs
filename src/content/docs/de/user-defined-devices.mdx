...
| `batterymode` | `int` | nein      | `battery` | Setze Lademodus direkt (1: normal, 2: hold, 3: charge, 4: holdcharge)                                                                                 |
...
Die Anbindung über einen einzelnen Schaltkontakt ist die einfachste Lösung.
Die Steuerbox aktiviert einen Kontakt, der von deiner evcc-Instanz ausgewertet wird.
...
Steuerbox und evcc müssen einmalig [gekoppelt](/de/external-limit#eebus-pairing) werden.
