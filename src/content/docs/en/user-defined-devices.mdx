...
| `batterymode` | `int` | no       | `battery` | Set charging mode directly (1: normal, 2: hold, 3: charge, 4: holdcharge)                                                                                         |
...
The connection via a single switch contact is the simplest solution.
The control box activates a contact which is evaluated by your evcc instance.
...
Control box and evcc need to be [paired](/en/external-limit#eebus-pairing) once.
